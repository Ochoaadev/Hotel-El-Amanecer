      ...
      <div className="bg-crema shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <form onSubmit={handleSubmit} className='bg-crema'>
          ...
          <button
              ...
              className="bg-azul hover:bg-gray-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            >
              Entrar
            </button>
            <Link className="bg-azul hover:bg-gray-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" to="/Registro">
                  Registrarse
            </Link>
          </div>
        </form>
