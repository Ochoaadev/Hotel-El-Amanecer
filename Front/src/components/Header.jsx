  ...
  return (
    <>
      <header className="bg-oscuro flex items-center justify-center xl:justify-between w-full py-4 px-8 h-[14vh] z-50">
        <div className="w-3/4 md:w-2/3 xl:w-2/5 text-start">
        ...
        >
          ...
          <Link className="font-bold text-blanco" to={"/Rooms"}>Habitaciones</Link>
          <Link className="font-bold text-blanco" to={"/Reservas"}>Reservar</Link>
          ...
          {isAuthenticated ? (
            ...
            <div className="flex justify-center flex-col xl:flex-row gap-6 xl:gap-3">
              <Link className="bg-white text-oscuro rounded-md xl:rounded-lg border border-transparent hover:bg-oscuro hover:text-claro hover:border-claro py-2 px-4 font-bold text-center transition-all duration-300 ease-in-out transform" to={"/Login"}>Iniciar Sesión</Link>
              <Link className="bg-marron text-blanco rounded-md xl:rounded-lg border border-transparent hover:bg-crema hover:text-oscuro hover:border-crema py-2 px-4 font-bold text-center transition-all duration-300 ease-in-out transform" to={"/Registro"}>Registrarse</Link>
            </div>
          )}
        </nav>
